    ...
    return (
        <>
            ...
            >
                ...
                <div className="breadcrumbs bg-white py-20 mt-20 section-padding bg-cover bg-center bg-no-repeat">
                                        ...
                                        <div className="flex space-x-4 items-center group">
                                            <div className="flex-none">
                                                <div className="h-12 w-12 rounded">
                                                    <img
                                                        src="/src/assets/homein/girl.jpg"
                                                        alt=""
                                            ...
                                            <li className=" flex space-x-4 border-[#ECECEC] pb-6 mb-6 last:pb-0 last:mb-0 last:border-0 border-b">
                                                <div className="flex-none ">
                                                    <div className="h-20 w-20  rounded">
                                                        <img
                                                            src="/src/assets/homein/banner-1.jpg"
                                                            alt=""
